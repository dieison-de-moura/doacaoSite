...
Route::post('/admin/hospital/deletar', ['as' => 'admin.hospital.deletar', 'uses' => 'Admin\HospitalController@deletar']); //editar hospitais
...
Route::post('/admin/doacao/deletar', ['as' => 'admin.doacao.deletar', 'uses' => 'Admin\requerDoacaoController@deletar']); //editar hospitais

                        ...
                        <div class="form-group row">
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" required name="termos_de_uso" id="termos_de_uso" {{ old('termos_de_uso') ? 'checked' : '' }}>

                                    <label class="form-check-label" for="termos_de_uso">
                                        {{-- {{ __('Termos de uso') }} --}}
                                        Aceitar <a href="{{ route('admin.termos_uso') }}">termos de uso</a>
                                    </label>
                                </div>
                            </div>
                        </div>
